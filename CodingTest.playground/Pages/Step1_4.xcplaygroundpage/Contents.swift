...
*/
func solution9(_ name:[String], _ yearning:[Int], _ photo:[[String]]) -> [Int] {
    var dic:[String:Int] = [:]
...
print(solution9(["may", "kein", "kain", "radi"], [5, 10, 1, 3], [["may", "kein", "kain", "radi"],["may", "kein", "brin", "deny"], ["kon", "kain", "may", "coni"]])) // [19, 15, 6]
